...
function contact() {
    ...
    const [expectedTimeCommitment, setExpectedTimeCommitment] = useState('I don’t know')
    ...
    return (
        <>
            ...
            {success && <Modal color={"bg-blue-100"} iconColor={'text-blue-600'} success={true} heading={"Thank You !"} paragraph={'Thanks for your interest. We will contact you shortly.'} />}
            {failure && <Modal color={"bg-red-100"} iconColor={'text-red-600'} heading={"Oops !"} paragraph={'We are unable to register your request at current time. Please send us an email at hello@hcode.tech'} />}
                                ...
                                <fieldset className="mt-6">
                                    <div>
                                        <legend className="text-sm font-medium text-gray-700">
                                            Will the project be run by a technical person like a Project manager/Engineering Manger/CTO etc?<sup>*</sup>
                                        </legend>
                                    </div>
