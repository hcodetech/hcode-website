...
import { metaData, terms_and_conditions_data } from "../constants/constants";

function term_and_conditions() {
  return (
    <section>
      <Head>
        <title>Terms and Conditions | Hcode Technologies </title>
        <MetaTags page={metaData.terms_and_conditions} />
      </Head>
      ...
      <div className="py-10 md:w-1/2   new-container">
        <div>
          <p>{terms_and_conditions_data.updated_paragraph}</p>
        ...
        <div>
          ...
          {terms_and_conditions_data.disclaimer_paragraph.map(
            (point, index) => (
              <p className="mt-2 text-sm" key={index}>
                {point.paragraph}
              </p>
        ...
        <div>
          ...
          <ul className="list-inside list-disc">
            {terms_and_conditions_data.limitations_of_liability_first_points.map(
              (point, index) => (
