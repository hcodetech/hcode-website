...
**ISP Advertising:** Internet service providers often advertise speeds in megabits per second (Mbps). This can lead to confusion, as consumers might think in terms of megabytes. Always remember the conversion factor **(1 MB = 8 Mb)** to set realistic expectations.
...
> Have you ever wondered why your download speed is 3MB/sec when you subscribe to a 25Mbps plan?
> 
> This is because of the difference between Megabits (Mb) and Megabytes (MB).
> 
> 1 Megabit (Mb) = 1,000,000 bits  
> 1 Megabyte (MB) = 8,000,000 bits
> 
> This means 1 MB is equivalent to 8 Mb.
> 
> — HCode Tech (@HcodeTech) [July 26, 2024](https://twitter.com/HcodeTech/status/1816713938374922535?ref_src=twsrc%5Etfw)
