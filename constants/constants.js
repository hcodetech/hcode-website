...
export const hiring_process = [
  ...
  },
  {
    ...
    description: 'If you make the cut, you’ll get the offer.',
  },
];
...
export const work_with_us_benefits = {
  ...
  points: [
    ...
    }, // { //   image: "/assets/img/pantry.svg", //   heading: "Subsidised Pantry", //   description: //     "We always make sure you have easy access to food and beverages, with free chai and coffee. ", // },
    {
...
export const work_with_us_image_carousel = [
  ...
  { image: '/assets/img/image_15.jpg' },
  { image: '/assets/img/image_16.jpg' },
  { image: '/assets/img/image_17.jpg' },
  { image: '/assets/img/image_18.jpg' },
  { image: '/assets/img/image_19.jpg' },
];
...
export const faq_blockchain = [
  ...
  {
    question:
      'What specific technologies and programming languages are integral to your workflow?',
    answer: `Our team is well-versed in a comprehensive set of technologies that cater to all aspects of blockchain development. Here's a breakdown of the tools we leverage:<br/><br/>
...
export const faqAi = [
  ...
  {
    question:
      'Do I need to have existing AI systems in place to benefit from your services?',
    answer:
      "No, you don't need existing AI systems. We work with businesses at all stages of AI adoption, from those looking to start integrating AI to those wanting to enhance their existing AI infrastructure.",
  },
  {
    question:
      'How long does it typically take to see results from AI integration?',
    answer:
      'The timeline for seeing results varies depending on the complexity of the project and specific goals. Some businesses may experience improvements in operational efficiency within weeks, while others may see substantial benefits over several months.',
  },
  {
    question:
      'What is the typical cost associated with AI integration services, and how can I determine the budget for my project?',
    answer:
      'The cost of AI integration can vary widely depending on project complexity and scope. We offer customized solutions, and the pricing is tailored to your specific needs. To determine a budget, we recommend discussing your requirements with our team for a detailed estimate.',
  },

  {
    question:
      'Are there any potential challenges or risks associated with AI integration, and how do you mitigate them?',
    answer:
      'While AI integration offers significant benefits, challenges may include data security, ethical concerns, and technology compatibility. We address these by implementing robust security measures, adhering to ethical AI principles, and conducting compatibility assessments.',
  },
  {
    question: 'Is my data secure when integrating AI into my systems?',
    answer:
      'Yes, data security is a top priority. We implement industry-standard security measures to protect your data throughout the AI integration process, ensuring confidentiality and compliance with privacy regulations.',
  },
];
