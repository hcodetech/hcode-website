export const navbar_links = [
  ...
      descripition:
        "Next you’d be needed to complete an online skill assessment test of any preferred coding language. Here, You get to show us that you are a rockstar coder. Smart freshers (strong aptitude) are given exception here",
    },
    {
      heading: "Interviews",
  ...
      },
      // {
      //   image: "/assets/img/pantry.svg",
      //   heading: "Subsidised Pantry",
      //   descripition:
      //     "We always make sure you have easy access to food and beverages, with free chai and coffee. ",
      // },
      {
  ...
      "Hire us to develop your groundbreaking idea"
    };
  ...
    paragraph:
      "Experienced and trained professional software developers, coming with the accountability of our organization, and much more responsible than an average freelancer.",
    points: [
      {
        image: "/assets/img/top_talent.svg",
        heading: "Top Talent",
  ...
    paragraph:
    "We are working with Global client for many years and from that, we have gained many different experiences which can help you grow your product",  points: [
      {
        image: "/assets/img/top_talent.svg",
        heading: "Top Talent",
        descripition:
  ...
          heading: "Top Talent",
          descripition:
            "Rigourously selected and professionally trained team, incentivized to be accountable, commercial and transparent in communication",
        },
        {
          image: "/assets/img/trust.svg",
          heading: "Trust",
  ...
      heading: "Startup Pace Work with Learning",
      points: [
  ...
        paragraph:
          "Get help in getting your Blockchain idea to the ground ",
        stacks: [
          {
  ...
        descripition:
        "Our NFT marketplace is very similar to the innumerable existing online marketplace to ease out your trading and transactions through facilitating familiarity."
      }, 
      {
  ...
        descripition:
        "We’re comfortable working with both techs as well as non-tech teams. If you don’t know about the choices you should make, we’re here to help make financially wise, and technologically sound decisions to set the right foundation for scale. "
      },
      {
        image: "/assets/img/trust.svg",
