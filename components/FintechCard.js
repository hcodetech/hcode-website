...
function FintechCard({ data }) {
  return (
    <div className={`bg-blue-100 grid md:grid-cols-2 bg-fintech px-4 py-8 md:p-16 md:h-[550px]  mb-20`}>
      <div className="">
        ...
        <div className={'bg-blue-400 md:w-3/4 p-2 md:p-4  mt-44 bottom-2'}>
          <p>{data.highlight}</p>
        </div>
      </div>
    </div>
